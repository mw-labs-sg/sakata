...
MARK = ('<svg class="sk-mark" width="30" height="30" viewBox="0 0 32 32" '
        ...
        '<path d="M24.8 9C28.7 14.1 27.4 21.8 22 25.3C16.6 28.8 9 26.9 '
        '5.8 21.4C2.5 15.7 5.1 9 10.5 6C12.8 4.8 15.3 4.4 17.8 4.9" '
        'stroke="currentColor" stroke-width="4.8" stroke-linecap="round"/>'
        '<path d="M6.3 22.4C4.3 18.7 4.4 14.2 6.7 10.6" stroke="currentColor" '
        'stroke-width=".68" stroke-linecap="round" opacity=".44"/>'
        '<path d="M24.45 8.7C25.45 7.65 26.35 6.95 27.5 6.45" '
        'stroke="currentColor" stroke-width="1.05" stroke-linecap="round" opacity=".78"/>'
        '<path d="M25.15 8.25L28.2 7.15" stroke="currentColor" stroke-width=".38" '
